...
<head>
  ...
  <title>
    Automated Watering System | Admin Profile
  </title>
  <!--     Fonts and icons     -->
    ...
    <nav class="navbar navbar-main navbar-expand-lg bg-transparent shadow-none position-absolute px-4 w-100 z-index-2">
      ...
      <div class="container-fluid py-1">
        ...
        <div class="collapse navbar-collapse me-md-0 me-sm-4 mt-sm-0 mt-2" id="navbar">
          ...
          <ul class="navbar-nav justify-content-end pt-3">
      ...
      <div class="card card-body blur shadow-blur mx-4 mt-n6 overflow-hidden">
        <div class="row gx-4">
          ...
          <div class="col-auto my-auto">
            <div class="h-100">
              <h5 class="mb-1" id = "admin_fullname">
                [Admin Fullname]
              </h5>
              <p class="mb-0 font-weight-bold text-sm" id = "admin_email">
                admin@gmail.com
              </p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills p-1 bg-transparent" role="tablist">
                ...
                <li class="nav-item">
                  <a class="btn btn-round bg-gradient-success" data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="false">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        ...
        <div class="col-12 col-xl-6">
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              <p class="text-sm" id = "admin_bio">
                Hi, I’m [Admin Fullname], I am an ML Engineer
              </p>
              <hr class="horizontal gray-light my-4">
              <ul class="list-group">
                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Full Name:</strong> &nbsp; <span id = "admin_fullname"></span></li>
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Mobile:</strong> &nbsp; <span id = "admin_mobile"></span></li>              
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Location:</strong> &nbsp; <span id = "admin_location"></span></li>
                <li class="list-group-item border-0 ps-0 pb-0 d-none">
        ...
        <div class="col-12 col-xl-6">
          <div class="card h-100">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">Recent Activity Logs</h6>
            </div>
            <div class="card-body p-3">
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  <div class="avatar me-2"> 
                      ...
                      <i class = "ni ni-circle-08 text-lg text-dark"></i>
                   
                  </div>
                  <div class="d-flex align-items-start flex-column justify-content-center">
                    <h6 class="mb-0 text-sm">Created new admin account</h6>
                    <p class="mb-0 text-xs">August 28, 2024 5:00 PM</p>
                  </div>
                  <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto text-success">View</a>
                </li> <!-- Activity Log Sample 1 -->
                ...
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  ...
                  <div class="d-flex align-items-start flex-column justify-content-center">
                    <h6 class="mb-0 text-sm">Updated new admin details</h6>
                    <p class="mb-0 text-xs">August 26, 2024 4:43 PM</p>
                  </div>
                  <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto text-success">View</a>
                </li> <!-- Activity Log Sample 2 -->

                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                  <div class="avatar me-2"> 
                  
                  
                      <i class = "ni ni-image text-lg text-dark"></i>
                   
                  </div>
                  <div class="d-flex align-items-start flex-column justify-content-center">
                    <h6 class="mb-0 text-sm">Changed plant image</h6>
                    <p class="mb-0 text-xs">August 22, 2024 5:50 AM</p>
                  </div>
                  <a class="btn btn-link pe-3 ps-0 mb-0 ms-auto text-success">View</a>
                </li> <!-- Activity Log Sample 3 -->
