...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start" id="sidenav-main" data-color = "success">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/data_analysis.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h5 class="font-weight-bolder mb-0">
                      5
                      <span class="text-success text-xs font-weight-bolder">2 Done Watering Today</span>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
                  <div class="icon icon-shape btn-outline-dark shadow text-center border-radius-md">
                    <i class="ni ni-app text-dark opacity-10" aria-hidden="true"></i>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h5 class="font-weight-bolder mb-0">
                      ...
                      <span class="text-success text-sm font-weight-bolder">3 Active</span>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Highest Soil Mosture</p>
                    <h5 class="font-weight-bolder mb-0">
                      40%
                      <span class="text-success text-sm font-weight-bolder">Plant 2</span>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
                  <div class="icon icon-shape btn-outline-dark shadow text-center border-radius-md">
                    <i class="ni ni-cloud-download-95 text-lg text-dark opacity-10" aria-hidden="true"></i>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Last Sprinkler Schedule</p>
                    <h5 class="font-weight-bolder mb-0">
                      Wed
                      <span class="text-success text-sm font-weight-bolder">4:00 PM</span>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
      ...
      <div class="row mt-4">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    <p class="mb-1 pt-2 text-bold mt-4">Welcome to </p>
                    <h5 class="font-weight-bolder">MALtech - Automated Watering System Admin</h5>
                    <p class="mb-5">This is your Dashboard!<br/>Helm the full control of your centralized watering system</p>
                    <a class="btn bg-gradient-white btn-round text-body btn-sm">
                      Try Now!
        ...
        <div class="col-lg-5">
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img/bgcurved01.jpg');">
              <span class="mask bg-gradient-dark"></span>
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                <h5 class="text-white font-weight-bolder mb-4 pt-2">Monitor your Plants in Real-Time!</h5>
                <p class="text-white">Get to know the status of your plants in real-time. You can monitor details thru connected sensors!</p>
                <button class="btn btn-sm btn-round text-white btn-outline-white font-weight-bold mb-0 mt-auto">
                  Go to Plants Monitoring
                  <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
                </button>
              </div>
            </div>
        ...
        <div class="col-lg-7">
          <div class="card z-index-2">
            <div class="card-header pb-0">
              <h6>Watering Schedule Consistency</h6>
              <p class="text-sm">
                <i class="fa fa-arrow-up text-success"></i>
                <span class="font-weight-bold text-success">+44%</span> in <span class = "font-weight-bold">September 2024</span> from October 2024
              </p>
            </div>
            <div class="card-body">
              <div class="chart">
    ...
    <div class="card shadow-lg ">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Admin UI Configurator</h5>
  ...
  <script>
    ...
    // For Curved Line Graph Gradient Shadow Colors
    ...
    new Chart(ctx2, {
      ...
      data: {
        ...
        datasets: [{
            ...
            fill: true,
            data: [0,1,21,50, 40, 300, 220, 500, 0, 0, 0, 0],
            maxBarThickness: 6

          },
          // Line Graph 2, Dark Blue
          // {
          //   label: "Websites",
          //   tension: 0.4,
          //   borderWidth: 0,
